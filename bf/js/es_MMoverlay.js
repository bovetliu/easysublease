...
MMoverlay.prototype.onAdd = function() {   //overwritten		
	...
	li3.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;launch activity here";
	ul.appendChild(li3);
...
MMoverlay.prototype.updatecat = function(string2) {  // string2 is id of coorespond li
	...
	//following code are using backbone
	temp_view =  EasySubOrg.RENTAL.rf_view_01;
	temp_view.$('#num-catagory').val( temp_view.associate_array2[string2] )	;  //hidden input
	temp_view.$('#btn-caption-cat').html( "Catagory: "+  temp_view.$('#'+string2).html())// document.getElementById(string2).firstChild.innerHTML )
	console.log("MMoverlay.updatecat verify: " + temp_view.$('#num-catagory').val() );	
}
...
MMoverlay.prototype.redirect_func = function (latLng, num){
	...
	//the run time of this part should be after DOM loaded
